...
<div class="container">
    ...
    <form method="post">
        <div class="mb-3">
            <label for="codigo" class="form-label">Agrega nombre o codigo al Producto </label>
            <input type="text" name="codigo" class="form-control" id="codigo" placeholder="Escribe">
        </div>
        <div class="mb-3">
        ...
        <div class="row">
            <div class="col">
                <label for="compra" class="form-label">Precio Sugerido</label>
                <input type="number" name="compra" step="any" id="compra" class="form-control" placeholder="Precio Sugerido de Venta" aria-label="">
            </div>
            <div class="col">
